...
func (n *Notification) UserConfigFields() []plugin.ConfigField {
	...
	fields = append(fields, createStringConfig(
		"mixin_id",
		i18n.UserConfigMixinIDTitle,
		i18n.UserConfigMixinIDLabel,
		i18n.UserConfigMixinIDDescription,
	))
...
func createStringConfig(name, title, label, desc string) plugin.ConfigField {
	return plugin.ConfigField{
		Name:        name,
